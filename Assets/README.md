...
| 细则 | 各场景技术栈见 `Assets/Resources/` 下对应编号目录中的 `场景名_ReadMe.md` |
...
噪声阈值溶解，前沿留一条 HDR 亮边，亮边上再叠一层 UV 流光，外轮廓用菲涅尔。可用 0~1 进度，也可按时间自动往复。

- 场景：`Assets/Scenes/06.effect_DissolveFlow.unity`
- Shader：`ZZY/06.effect/DissolveFlow`
- 细则：[06.effect_DissolveFlow_ReadMe.md](Resources/06.effect/06.effect_DissolveFlow_ReadMe.md)
...
- 细则：[06.effect_FireRealistic_ReadMe.md](Resources/06.effect/06.effect_FireRealistic_ReadMe.md)
...
- 细则：[06.effect_FlowPipe_ReadMe.md](Resources/06.effect/06.effect_FlowPipe_ReadMe.md)
...
- 细则：[06.effect_FlowTranslucent_ReadMe.md](Resources/06.effect/06.effect_FlowTranslucent_ReadMe.md)
...
- 细则：[06.effect_Shield_ReadMe.md](Resources/06.effect/06.effect_Shield_ReadMe.md)
